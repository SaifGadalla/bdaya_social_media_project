...
class ReactiveUpdatePostReactiveModelFormConsumer extends StatelessWidget {
  const ReactiveUpdatePostReactiveModelFormConsumer({
    Key? key,
  ...
  final Widget Function(BuildContext context,
      UpdatePostReactiveModelForm formModel, Widget? child) builder;

  @override
  Widget build(BuildContext context) {
    final formModel = ReactiveUpdatePostReactiveModelForm.of(context);

    if (formModel is! UpdatePostReactiveModelForm) {
...
class UpdatePostReactiveModelFormInheritedStreamer
    extends InheritedStreamer<dynamic> {
  const UpdatePostReactiveModelFormInheritedStreamer({
    Key? key,
    required this.form,
  ...
  final UpdatePostReactiveModelForm form;
}

class ReactiveUpdatePostReactiveModelForm extends StatelessWidget {
  const ReactiveUpdatePostReactiveModelForm({
    Key? key,
    required this.form,
    required this.child,
    this.canPop,
  ...
  static UpdatePostReactiveModelForm? of(
    ...
    if (listen) {
      return context
          .dependOnInheritedWidgetOfExactType<
              UpdatePostReactiveModelFormInheritedStreamer>()
          ?.form;
    }
    ...
    return element == null
        ? null
        : (element.widget as UpdatePostReactiveModelFormInheritedStreamer).form;
  }

  @override
  Widget build(BuildContext context) {
    return UpdatePostReactiveModelFormInheritedStreamer(
      form: form,
...
extension ReactiveReactiveUpdatePostReactiveModelFormExt on BuildContext {
  UpdatePostReactiveModelForm? updatePostReactiveModelFormWatch() =>
      ReactiveUpdatePostReactiveModelForm.of(this);

  UpdatePostReactiveModelForm? updatePostReactiveModelFormRead() =>
      ReactiveUpdatePostReactiveModelForm.of(this, listen: false);
}

class UpdatePostReactiveModelFormBuilder extends StatefulWidget {
  const UpdatePostReactiveModelFormBuilder({
    Key? key,
    this.model,
    this.child,
    this.canPop,
  ...
  final UpdatePostReactiveModel? model;
  ...
  final void Function(
      BuildContext context, UpdatePostReactiveModelForm formModel)? initState;

  @override
  _UpdatePostReactiveModelFormBuilderState createState() =>
      _UpdatePostReactiveModelFormBuilderState();
}

class _UpdatePostReactiveModelFormBuilderState
    extends State<UpdatePostReactiveModelFormBuilder> {
  late UpdatePostReactiveModelForm _formModel;

  @override
  void initState() {
    _formModel = UpdatePostReactiveModelForm(
        UpdatePostReactiveModelForm.formElements(widget.model), null);
  ...
  @override
  void didUpdateWidget(covariant UpdatePostReactiveModelFormBuilder oldWidget) {
  ...
  @override
  Widget build(BuildContext context) {
    return ReactiveUpdatePostReactiveModelForm(
...
class UpdatePostReactiveModelForm
    implements FormModel<UpdatePostReactiveModel> {
  UpdatePostReactiveModelForm(
    this.form,
    this.path,
  );
  ...
  @override
  UpdatePostReactiveModel get model {
    final isValid = !currentForm.hasErrors && currentForm.errors.isEmpty;

    if (!isValid) {
      debugPrintStack(
          label:
              '[${path ?? 'UpdatePostReactiveModelForm'}]\n┗━ Avoid calling `model` on invalid form. Possible exceptions for non-nullable fields which should be guarded by `required` validator.');
    }
    return UpdatePostReactiveModel(
  ...
  @override
  void submit({
    required void Function(UpdatePostReactiveModel model) onValid,
  ...
  @override
  void updateValue(
    UpdatePostReactiveModel? value, {
    bool updateParent = true,
    bool emitEvent = true,
  }) =>
      form.updateValue(UpdatePostReactiveModelForm.formElements(value).rawValue,
          updateParent: updateParent, emitEvent: emitEvent);
  ...
  static FormGroup formElements(
          UpdatePostReactiveModel? updatePostReactiveModel) =>
      FormGroup({
        postFormsControlName: FormArray(
            (updatePostReactiveModel?.postForms ?? [])
        ...
        imageFormsControlName: FormControl<List<SelectedFile>>(
            value: updatePostReactiveModel?.imageForms,
            validators: [],
            asyncValidators: [],
            asyncValidatorsDebounceTime: 250,
            disabled: false,
...
class ReactiveUpdatePostReactiveModelFormArrayBuilder<
    ReactiveUpdatePostReactiveModelFormArrayBuilderT> extends StatelessWidget {
  const ReactiveUpdatePostReactiveModelFormArrayBuilder({
    Key? key,
    this.control,
    this.formControl,
    this.builder,
  ...
  final FormArray<ReactiveUpdatePostReactiveModelFormArrayBuilderT>?
      formControl;

  final FormArray<ReactiveUpdatePostReactiveModelFormArrayBuilderT>? Function(
      UpdatePostReactiveModelForm formModel)? control;

  final Widget Function(BuildContext context, List<Widget> itemList,
      UpdatePostReactiveModelForm formModel)? builder;

  final Widget Function(
      BuildContext context,
      int i,
      ReactiveUpdatePostReactiveModelFormArrayBuilderT? item,
      UpdatePostReactiveModelForm formModel) itemBuilder;
  ...
  Widget build(BuildContext context) {
    ...
    return ReactiveFormArray<ReactiveUpdatePostReactiveModelFormArrayBuilderT>(
...
class ReactiveUpdatePostReactiveModelFormFormGroupArrayBuilder<
        ReactiveUpdatePostReactiveModelFormFormGroupArrayBuilderT>
    extends StatelessWidget {
  const ReactiveUpdatePostReactiveModelFormFormGroupArrayBuilder({
    Key? key,
    this.extended,
    this.getExtended,
    this.builder,
  ...
  final ExtendedControl<List<Map<String, Object?>?>,
          List<ReactiveUpdatePostReactiveModelFormFormGroupArrayBuilderT>>?
      extended;

  final ExtendedControl<List<Map<String, Object?>?>,
          List<ReactiveUpdatePostReactiveModelFormFormGroupArrayBuilderT>>
      Function(UpdatePostReactiveModelForm formModel)? getExtended;
  ...
  final Widget Function(
      BuildContext context,
      int i,
      ReactiveUpdatePostReactiveModelFormFormGroupArrayBuilderT? item,
      UpdatePostReactiveModelForm formModel) itemBuilder;
